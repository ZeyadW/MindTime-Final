...
class BookTestsOnlineThirdStep extends StatefulWidget {
  @override
  _BookTestsOnlineThirdStepState createState() =>
      _BookTestsOnlineThirdStepState();
}
              ...
              child: Center(
                child: Container(
                    padding: const EdgeInsets.only(
                        top: 12.0, left: 12.0, right: 12.0, bottom: 20),
                    child: Row(
                    ...
                    child: Stack(
                      children: <Widget>[
                        Container(
                            ...
                            child: Wrap(children: _buildChoiceList(nightList))),
                        Container(
                          padding: const EdgeInsets.only(
                            top: 6,
                            bottom: 6,
