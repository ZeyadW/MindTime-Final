...
import 'package:medico/pages/viewjournaldoc.dart';
//import 'package:medico/widgets/viewjournal/addjournalbuttonwidget.dart';
import 'package:shared_preferences/shared_preferences.dart';

class ListAllJournalsPatient extends StatefulWidget {
  @override
...
class _ListAllJournalState extends State<ListAllJournalsPatient> {
                ...
                child: FlatButton(
                  ...
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => ViewJournaldoc(diary)),
                    );
                  },
                ),
              ),
