...
//            title: Center(child: Image(image: AssetImage('images/Icon.png'))),
      ...
      body: Column(
        children: [
          new SingleChildScrollView(child: ListAllJournalsPatient()),
        ],
      ),
    );
  }
